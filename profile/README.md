...
| | 메세지 큐 <br/> (RabbitMQ) | 회원 | Oauth2, JWT | 
...
| ELK Stack | CI/CD(무중단 배포) <br/> front-end| 로그인 JWT<br/>Spring Security | 사용자 휴면 전환<br/>(Spring Batch) |
| 카테고리 | 장바구니 (redis) | 주문, 결제<br/>Toss Payments API | CI/CD<br/>(Shell Script, <br/> Health Check) |
| 도서 | 태그 | | 리뷰(이미지 포함) |
|  | | | API 명세(Rest Docs) |
